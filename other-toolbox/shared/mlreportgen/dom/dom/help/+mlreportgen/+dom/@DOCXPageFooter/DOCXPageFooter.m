%mlreportgen.dom.DOCXPageFooter Page footer for a Word document.
%    footer = DOCXPageFooter() creates a default page footer based on the 
%    DOM API's default DOCX template.
%
%    footer = DOCXPageFooter('pagetype') creates a page footer that applies
...
%
%    footer = DOCXPageFooter('pagetype', 'templatepath') creates a page   
...
%
%    footer = DOCXPageFooter('pagetype', 'templatepath', 'embeddedTemplateName') 
%    creates a footer of the specified page type based on a template of the 
%    specified name stored in the specified template.
%
%    footer = DOCXPageFooter('pagetype', templatesrc, 'buildingblockname') 
%    creates a footer of the specified page type based on a template of the 
